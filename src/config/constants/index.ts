 ...
 * tokens.
 * @example [AMPL.address]: [DAI, WCRO[ChainId.MAINNET]]
 */
...
export const addresses: { [index: string]: Address } = {
  kryptolite: {
    97: "",
    25: "0x69A3C92cE7d543f6aaC7630E0e4Df265BdBB8c0D",
  },
  kryptoliteSwapRefereeTracker: {
    97: "",
    25: "0x9e42C733D6C46c2abA04cA5802D71d0D652499A2",
  },
  multiCall: {
  ...
  router: {
    25: "0xdDAD3ED378830d406D8957Ca76782A7ECD8A7061",
    97: "",
  },
};
...
export const MIN_CRO: JSBI = JSBI.exponentiate(
  JSBI.BigInt(10),
  JSBI.BigInt(16)
);
