...
import { CRO } from "../entities/currency";
...
export abstract class Router {
  ...
  public static swapCallParameters(
    ...
    const etherIn = trade.inputAmount.currency === CRO;
    const etherOut = trade.outputAmount.currency === CRO;
    // the router does not support both ether in and out
    invariant(!(etherIn && etherOut), "CRO_IN_OUT");
